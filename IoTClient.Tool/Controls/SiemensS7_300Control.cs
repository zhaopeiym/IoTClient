...
{
    public partial class SiemensS7_300Control : UserControl
    {
        SiemensClient client;
        SiemensServer server;
        public SiemensS7_300Control()
        {
            InitializeComponent();
        ...
        private void but_open_Click(object sender, EventArgs e)
        {
            ...
            {
                client?.Close();
                client = new SiemensClient(SiemensVersion.S7_300, txt_ip.Text?.Trim(), int.Parse(txt_port.Text.Trim()));
