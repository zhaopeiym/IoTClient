...
{
    public class MitsubishiClientCommunication : IIoTClientCommon
    {
        ...
        public MitsubishiClientCommunication(MitsubishiVersion version, string ip, int port, int timeout = 1500)
        {
            switch (version)
            {
                case MitsubishiVersion.A_1E:
                    DeviceVersion = EthernetDeviceVersion.Mitsubishi_A_1E.ToString();
                    break;
                case MitsubishiVersion.Qna_3E:
                    DeviceVersion = EthernetDeviceVersion.Mitsubishi_Qna_3E.ToString();
                    break;
            }
            client = new MitsubishiClient(version, ip, port, timeout);
        }
